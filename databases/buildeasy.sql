...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2018 at 01:19 PM
...
INSERT INTO `cart` (`id`, `id_custmor`, `service_id`, `service`, `category`, `date`) VALUES
(4, 0, 1, 'bamboo', 'Construction Material Dealers', '2017-06-13'),
(5, 0, 7, 'Glulam', 'Construction Material Dealers', '2017-06-13'),
(6, 0, 12, 'Plywood & Boards', 'Construction Material Dealers', '2017-06-13'),
(7, 0, 19, 'Gas Metal Arc Welding', 'Construction Service Providers', '2017-06-13');
...
CREATE TABLE `custmors` (
  ...
  `isEmailConfirmed` int(4) NOT NULL,
...
(1, 'sree7convention.com', 'venkyhack452@gmail.com', '8790010929', 'IMG_20180107_093808422.jpg', '$2y$10$dwmqokN12dXFQrObUTJWdOWD/yPky9Pcnl/r/la7EjBoZqOhFQdJS', 1, '', '0000-00-00');
...
(1, 1, '4-933, kotha reddy palem', 'seethamma dara, vizag');
